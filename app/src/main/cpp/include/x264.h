...
/* Zones: override ratecontrol or other options for specific sections of the core.video.
...
typedef struct x264_param_t
{
    ...
    /* Cropping Rectangle parameters: added to those implicitly defined by
       non-mod16 core.video resolutions. */
    struct
    {
        int i_left;
        int i_top;
    ...
    /* Don't optimize header parameters based on core.video content, e.g. ensure that splitting an input core.video, compressing
     ...
     * to begin processing core.video data (e.g. by sending packets over a network) before the frame
     * is done encoding.
     *
